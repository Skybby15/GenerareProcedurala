...
import { SceneSettings } from "../helpers/types/SceneSettings";

type CustomSceneProps = {
    config: CAConfigValues;
}

export default function CustomScenePage({ config }: CustomSceneProps) {
  const mountRef = useRef<HTMLDivElement>(null);
  const [settings] = useState(SceneSettings.default)
